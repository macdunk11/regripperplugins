#-----------------------------------------------------------
# winmail_recently_used_addresses.pl
#   Plugin for Registry Ripper, NTUSER.DAT edition - gets last 29 email
#   addresses that the user sent emails to  using Windows Vista Mail Client
#
# Change history
...
#########################COPYRIGHT INFORMATION############################
#-----------------------------------------------------------
package winmail_recently_used_addresses;
use strict;
...
sub pluginmain {
	my $class = shift;
	my $ntuser = shift;
	::logMsg("Launching winmail_recently_used_addresses v.".$VERSION);
    	::rptMsg("winmail_recently_used_addresses v.".$VERSION); 
